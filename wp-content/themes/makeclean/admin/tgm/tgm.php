...
add_action( 'tgmpa_register', 'makeclean_register_required_plugins' );
/**
 ...
 */
function makeclean_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name' => 'Makeclean Toolkit', // The plugin name.
			'slug' => 'makeclean-toolkit', // The plugin slug (typically the folder name).
			'source' => get_template_directory() . '/admin/plugins/makeclean-toolkit.zip', // The plugin source.
	 ...
	 */
	$config = array(
		'id'           => "makeclean",                 // Unique ID for hashing notices for multiple instances of TGMPA.
